...
{{< call-out class="note" >}} These collectors are for demonstration purposes and are not tuned for production use. {{< /call-out >}}
...
{{< call-out class="note" >}} Ensure that you [install the Gateway API resources]({{< ref "/ngf/install/helm.md#installing-the-gateway-api-resources" >}}).{{< /call-out >}}
